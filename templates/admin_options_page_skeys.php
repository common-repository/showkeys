                ...
                <div class="inside">
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><?= esc_html__('Explicit Exceptions', 'skey') ?>:</th>
                                <td valign="middle">
                                    <p><?= esc_html__('If you want the exact characters you specify to be output, then just add', 'skey') ?> <code>ex="on"</code> <?= esc_html__('in the shortcode and the automatic conversion will be disabled for that one shortcode output.', 'skey') ?></p>
                                    <br>
                                    <p><?= esc_html__('Example', 'skey') ?>: <code>[skey k="Alt+Shift+Tab" ex="on"]</code></p>
                                    <br>
                                    <p><?= esc_html__('Output', 'skey') ?>: <kbd class="skey skey-<?= $skey_options['style'] ?>">Alt</kbd> + <kbd class="skey skey-<?= $skey_options['style'] ?>">Shift</kbd> + <kbd class="skey skey-<?= $skey_options['style'] ?>">T</kbd></p>
                                    <br>
                                    <hr>
                ...
                <div class="inside">
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><?= SKEY__TITLE ?> <?= esc_html__('on GitHub', 'skey') ?>:</th>
                                <td valign="middle">
                                    <a href="https://github.com/mariojacob/showkeys" target="_blank" title="<?= SKEY__TITLE ?> <?= esc_html__('on GitHub', 'skey') ?>">github.com/mariojacob/showkeys</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
